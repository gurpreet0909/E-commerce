...
import com.gurpreet.onlineshopping.util.FileUploadUtility;
import com.gurpreet.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results,
		...
		if(mProduct.getId()==0) {
		// handle image validations for new products
	...
	public String handleProductActivation(@PathVariable int id) {
		// is goign to fetch from database
	...
	// to handle category submisson
	@RequestMapping(value="/category", method=RequestMethod.POST)
		public String handleCategorySubmission(@ModelAttribute Category category) {
		// add the new categroy
